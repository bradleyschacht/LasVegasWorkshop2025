...
1. Return to the *Modern Data Warehousing on Microsoft Fabric* workspace created in Lab 1 by selecting the workspace icon from the left navigation bar. *Note: .*

    <img src = "../assets/images/02_navigation_bar_.png"/>
